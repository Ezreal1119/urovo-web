          ...
          <div className="space-y-2">
            <div className="space-y-1">
              ...
              <p className="text-xs text-foreground/40">
                You can also contact me directly via email: patrick@urovo.com
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-5 px-6">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="h-11 rounded-xl border-white/10 bg-white/[0.04] text-foreground placeholder:text-foreground/35"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              className="min-h-[140px] rounded-2xl border-white/10 bg-white/[0.04] text-foreground placeholder:text-foreground/35"
            />
          </div>
        ...
        <div className="border-t border-white/8 px-6 py-4">
          <div className="flex items-center justify-end gap-3">
            ...
            <Button
              ...
              disabled={!title.trim() || !content.trim() || !email.trim()}
