...
export function ProductSpinHero({
  ...
  const [activeView, setActiveView] = React.useState<ViewKey>("front");
  ...
  const highlights = [
    ...
    { label: "Display", value: '6.745" 720×1600 (Dual-Screen optional)' },
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            <div className="flex items-start justify-between gap-4">
              ...
              <Link
                href="/projects/pos/i9600/s7d3f5g9"
          ...
          <div className="flex flex-wrap gap-2">
            {(
              ["front", "left", "right", "back", "top", "bottom"] as ViewKey[]
            ).map((key) => (
              <button
                key={key}
                type="button"
