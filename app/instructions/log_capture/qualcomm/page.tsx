                  ...
                  <ul className="space-y-2">
                    ...
                    <li>
                      ...
                      <ul className="pl-6 space-y-1 mt-1">
                        ...
                        <li>
                          ◦ Type <CodeInline>powershell</CodeInline> in the file
                          path section, then press <strong>"Enter"</strong>{" "}
                          button on the keyboard. The Powershell will pop up.
                        </li>
                        <li>
                        ...
                        <li>
                          ◦ For example: use{" "}
                          <CodeInline>.\adb devices</CodeInline> to check if any
